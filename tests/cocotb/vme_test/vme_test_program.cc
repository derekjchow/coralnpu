...
static inline __attribute__((always_inline))
uint32_t vme_msettn(uint32_t avl) {
...
static inline __attribute__((always_inline))
uint32_t vme_msettm(uint32_t new_tm) {
...
static inline __attribute__((always_inline))
uint32_t vme_msettk(uint32_t new_tk) {
...
static inline __attribute__((always_inline))
void vme_msetmtypei_mtwiden3_sew8(void) {
...
VmeMsetResult vme_results[VME_MAX_CASES]
    __attribute__((section(".data"))) = {};
